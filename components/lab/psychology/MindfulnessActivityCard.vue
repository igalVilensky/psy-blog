...
<template>
  ...
  >
    ...
    <div
      ...
      :class="`bg-gradient-to-br ${activity.color}`"
      style="opacity: 0.05"
    ></div>
    ...
    <!-- Decorative Corner -->
    <div
      class="absolute bottom-0 right-0 w-16 h-16 opacity-5 transition-opacity duration-300 group-hover:opacity-10"
      :class="`bg-gradient-to-tl ${activity.color}`"
