...
<template>
  ...
  >
    ...
    <div class="relative z-10">
      ...
      <div
        class="mt-4 pt-4 border-t border-slate-700/50 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0"
        v-if="!isActive"
      >
        <div class="flex items-center justify-between text-xs">
          <span class="text-slate-500">Нажмите для подробностей</span>
