  ...
  >
    ...
    <div class="relative z-10">
      ...
      <div class="flex items-start justify-between mb-4">
        ...
        <span
          class="text-xs px-3 py-1 rounded-full bg-slate-700/50 text-slate-400 border border-slate-600/30"
        >
      ...
      <p
        class="text-slate-400 text-sm mb-4 leading-relaxed group-hover:text-slate-300 transition-colors"
      >
      ...
      <div class="flex flex-wrap gap-2 mb-4">
        <span
          ...
          :key="benefit"
          class="text-xs px-2 py-1 rounded-lg bg-slate-700/30 text-slate-500 border border-slate-600/30"
        >
          {{ benefit }}
        </span>
      </div>
