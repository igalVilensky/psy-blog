...
const kids = ref([
  {
    ...
    photo: "/amelie.png",
    message:
      "Мамочка, ты самая красивая принцесса на свете! 💖 Спасибо за все сказки, объятия и смех. Люблю тебя больше всех на свете! Ты мой лучший друг и самая добрая мама! 👑✨",
    icon: "fas fa-crown",
    theme: {
