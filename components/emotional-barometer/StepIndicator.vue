  ...
  <div class="mb-8">
    ...
    <div class="flex justify-between items-center mb-3">
      <div class="flex items-center gap-2">
        <div
          class="w-8 h-8 rounded-full bg-[#FF6B6B] text-white flex items-center justify-center text-sm font-medium"
        >
          {{ currentStep }}
        </div>
      ...
      <span
        class="text-sm font-medium text-gray-700 px-4 py-1 bg-gray-100 rounded-full"
      >
        {{ stepTitle }}
      </span>
    </div>
    ...
    <div class="relative w-full">
      ...
      <div class="w-full bg-gray-200 rounded-full h-2.5">
        <!-- Progress fill -->
        <div
          class="bg-[#FF6B6B] h-2.5 rounded-full transition-all duration-500 ease-in-out"
        ...
        >
          ...
          >
            <div class="w-4 h-4 bg-[#FF6B6B] rounded-full">
              <div
                class="absolute inset-0 rounded-full bg-[#FF6B6B] animate-ping opacity-75"
              ></div>
            </div>
          </div>
        </div>
