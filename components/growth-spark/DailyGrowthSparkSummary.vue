    ...
    <div class="relative z-10 bg-white/5 backdrop-blur-lg p-6 sm:p-8">
      ...
      <div v-else-if="!user || !hasData" class="text-center space-y-6">
        ...
        <div class="flex justify-center gap-4">
          <Button v-if="!user" text="Войти" iconClass="fas fa-sign-in-alt"
          ...
          <Button v-else text="Начать" iconClass="fas fa-play"
            customClass="px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-medium rounded-lg hover:from-indigo-500 hover:to-indigo-600 transition-all shadow-md hover:shadow-lg flex items-center"
            :isLink="false" @click="startDailySpark" />
        </div>
      </div>
      ...
      <div v-else class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div
            ...
            <div class="flex items-center mb-3">
              ...
              <h4 class="font-semibold text-indigo-300 group-hover:text-indigo-200 transition-colors">
                Всего записей
              </h4>
            </div>
            <p class="text-3xl font-bold text-white group-hover:text-indigo-200 transition-colors">
              {{ stats.totalEntries }}
            </p>
          </div>
          ...
          <div
            ...
            <div class="flex items-center mb-3">
              <div class="p-2 bg-amber-500/20 rounded-lg mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-amber-400" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <h4 class="font-semibold text-amber-300 group-hover:text-amber-200 transition-colors">
                Серия дней
              </h4>
            </div>
            <p class="text-3xl font-bold text-white group-hover:text-amber-200 transition-colors">
              {{ stats.longestStreak }}
            </p>
          </div>
          ...
          <div
            ...
            <div class="flex items-center mb-3">
              ...
              <h4 class="font-semibold text-emerald-300 group-hover:text-emerald-200 transition-colors">
                Очки
              </h4>
            </div>
            <p class="text-3xl font-bold text-white group-hover:text-emerald-200 transition-colors">
              {{ stats.totalPoints }}
            </p>
          </div>
        </div>
        ...
        <div
          ...
          <div class="flex items-center mb-3">
            ...
            <h4 class="font-semibold text-purple-300 group-hover:text-purple-200 transition-colors">
