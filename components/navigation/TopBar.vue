<template>
  <nav class="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-sm border-b border-slate-800/60">
    <!-- Subtle accent line -->
    <div
    ...
    <div class="container max-w-6xl px-4 sm:px-0 mx-auto flex justify-between items-center py-3 relative z-10">
      ...
      <div class="hidden lg:flex items-center space-x-2">
        ...
        <div class="relative group">
          <NuxtLink to="/lab"
            ...
            :class="{ 'bg-slate-800/50 text-white': isLabRouteActive }" @click="closeDropdown">
            <i class="fas fa-flask text-cyan-400"></i>
            <span>Лаборатория</span>
            <i
              class="fas fa-chevron-down text-xs text-slate-400 group-hover:text-slate-300 transition-transform duration-200 group-hover:rotate-180"></i>
          </NuxtLink>
          <div
        ...
        <div class="relative group">
          ...
          <div
            ...
            <div
              ...
              <NuxtLink to="/awareness-tools/inspiration-wall"
                class="flex items-center space-x-3 px-4 py-2.5 text-[15px] text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors duration-150"
                exact-active-class="bg-slate-700/50 text-white" @click="closeDropdown">
        ...
        <ClientOnly>
          ...
          <div v-else-if="auth.user" class="relative group ml-2">
            <button
              ...
              <span class="text-[15px] text-slate-300 font-medium group-hover:text-white max-w-[100px] truncate">
      ...
      <div data-menu="mobile" :class="[
        ...
        <div class="p-4 space-y-2">
          ...
          <div>
            <div
              ...
              <button @click="toggleMobileSubmenu('lab')"
                ...
                <i class="fas fa-chevron-down text-slate-400 text-sm transition-transform duration-200" :class="[
          ...
          <!-- Сообщество -->
          <div>
            <button @click="toggleMobileSubmenu('community')"
            ...
            <div class="mt-1.5 rounded-lg overflow-hidden transition-all duration-300 ease-in-out" :class="[
              ...
              <div class="bg-slate-800/30 p-2 space-y-1">
                ...
                <NuxtLink to="/faq"
                  class="flex items-center space-x-2.5 px-3 py-2 text-sm text-slate-300 hover:text-white hover:bg-slate-700/50 rounded-lg transition-colors duration-150"
                  exact-active-class="bg-slate-700/50 text-white" @click="closeDropdown">
                  <i class="fas fa-question-circle text-blue-400 text-xs w-4"></i>
                  <span>FAQ</span>
                </NuxtLink>
                <NuxtLink to="/contact"
                  class="flex items-center space-x-2.5 px-3 py-2 text-sm text-slate-300 hover:text-white hover:bg-slate-700/50 rounded-lg transition-colors duration-150"
          ...
          <NuxtLink to="/about"
            ...
            exact-active-class="bg-slate-800/70 text-white" @click="closeDropdown">
          ...
          <div class="pt-3 border-t border-slate-800/60 mt-3">
            <ClientOnly>
              ...
              <template v-else-if="auth.user">
                <div class="mb-3 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
              ...
              <template v-else>
                <div class="space-y-2">
                  <NuxtLink to="/login"
                    ...
                    exact-active-class="bg-slate-800/50 text-white border-cyan-500/50" @click="closeDropdown">
