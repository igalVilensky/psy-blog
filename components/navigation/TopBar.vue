      ...
      <div class="relative xl:hidden mobile-menu" data-menu="mobile">
        ...
        >
          ...
          <li class="relative">
            <div
              class="px-8 py-2 text-white transition-colors duration-300 ease-in-out hover:bg-pink-600 cursor-pointer flex items-center justify-between"
              @click="toggleAwarenessMobileSubmenu"
            >
              Инструменты осознанности
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <AwarenessToolsMobileSubmenu
              :isOpen="isMobileAwarenessSubmenuOpen"
            />
          </li>
          <li>
            <NuxtLink
...
const isMobileAwarenessSubmenuOpen = ref(false);
...
const toggleAwarenessMobileSubmenu = () => {
  isMobileAwarenessSubmenuOpen.value = !isMobileAwarenessSubmenuOpen.value;
};
