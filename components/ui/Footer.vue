...
const sitemapLinks = [
  ...
  { label: "Эмоциональный компас", to: "/lab/experiments/emotional-compass" },
  { label: "Колесо баланса", to: "/lab/experiments/wheel-of-life" },
  { label: "12 Архетипов", to: "/lab/experiments/life-purpose-archetype" },
  { label: "Большая пятёрка", to: "/lab/experiments/big-5-model" },
