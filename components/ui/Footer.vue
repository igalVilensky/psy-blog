<template>
  <footer
    class="relative bg-slate-950 overflow-hidden text-white border-t border-slate-800/60"
  >
    <!-- Subtle top glow -->
    <div
    ...
    >
      ...
      >
        ...
        <div class="animate-fade-in-up">
          ...
          <div
            class="w-12 h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full mb-4 md:mb-6"
          ></div>
          <ul class="space-y-2.5 md:space-y-3">
            <li v-for="(link, index) in sitemapLinks" :key="index">
              <NuxtLink
                :to="link.to"
                exact-active-class="text-cyan-400 font-semibold"
                class="text-slate-400 hover:text-cyan-400 transition-all duration-300 flex items-center group text-sm md:text-base"
              >
                <span
                  class="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-2 scale-0 group-hover:scale-100 transition-transform duration-300"
                ></span>
                {{ link.label }}
              </NuxtLink>
            </li>
        ...
        <div class="animate-fade-in-up" style="animation-delay: 0.1s">
          ...
          <div
            class="w-12 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mb-4 md:mb-6"
          ></div>
          <div class="flex flex-wrap gap-3 md:gap-4">
            ...
            >
              ...
              ></div>
              <div
                class="relative w-12 h-12 md:w-14 md:h-14 bg-slate-800/60 border border-slate-700/60 rounded-xl flex items-center justify-center group-hover:border-purple-500/60 group-hover:bg-slate-800 transition-all duration-300 group-hover:scale-110"
              >
                <i
                  :class="social.icon"
                  class="text-xl md:text-2xl text-slate-400 group-hover:text-white transition-colors duration-300"
                ></i>
              </div>
            </a>
          </div>
        ...
        <!-- Newsletter Section -->
        <div
          class="sm:col-span-2 animate-fade-in-up"
        ...
        >
          ...
          <div
            class="w-12 h-1 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 rounded-full mb-4 md:mb-6"
          ></div>
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <input
              ...
              class="flex-1 px-4 py-3 md:py-3.5 rounded-xl bg-slate-800/60 border border-slate-700/60 text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500/60 focus:ring-2 focus:ring-cyan-500/20 transition-all text-sm md:text-base"
            />
            <button
      ...
      <!-- Copyright Section -->
      <div class="mt-12 md:mt-16 pt-8 border-t border-slate-800/60">
        <div
          class="flex flex-col md:flex-row justify-between items-center gap-4"
        >
          <p
            class="text-slate-500 text-sm md:text-base text-center md:text-left"
          >
            © {{ new Date().getFullYear() }} MindQ Lab. Все права защищены.
          </p>
          <div
            class="flex flex-wrap justify-center gap-4 md:gap-6 text-sm md:text-base"
          >
            <NuxtLink
              to="/legal/privacy"
...
const sitemapLinks = [
  ...
  { label: "Эмоциональный компас", to: "/awareness-tools/emotional-compass" },
  { label: "Колесо баланса", to: "/awareness-tools/wheel-of-life" },
  { label: "12 Архетипов", to: "/awareness-tools/life-purpose-archetype" },
  { label: "Большая пятёрка", to: "/awareness-tools/big-5-model" },
