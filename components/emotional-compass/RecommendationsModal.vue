  ...
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div
      ...
      <div class="px-6 pb-6 space-y-6">
        <!-- Emotion Summary -->
        <div class="backdrop-blur-sm border border-cyan-500/20 bg-slate-50 dark:bg-[#1A1F35]/40 rounded-xl p-4">
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2">
            <div v-for="(rec, index) in recommendations" :key="index" class="group relative">
