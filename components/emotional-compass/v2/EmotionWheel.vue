      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div class="relative z-10">
            <div class="text-xl font-bold text-slate-800 dark:text-slate-100 mb-1 tracking-tight group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
              {{ family.name }}
            </div>
