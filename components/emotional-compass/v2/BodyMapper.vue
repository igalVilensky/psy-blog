<template>
  <div class="body-mapper w-full max-w-md mx-auto">
    <div
      class="relative aspect-[3/4] bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-800 p-4">
      ...
      <svg viewBox="0 0 200 400" class="w-full h-full drop-shadow-xl">
        ...
        <!-- Throat -->
        <path d="M85 95 Q 100 105, 115 95 L 115 110 Q 100 115, 85 110 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
        ...
        <!-- Chest -->
        <path d="M70 110 Q 100 120, 130 110 L 140 180 Q 100 190, 60 180 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
        ...
        <!-- Stomach/Gut -->
        <path d="M60 180 Q 100 190, 140 180 L 135 240 Q 100 250, 65 240 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
        ...
        <path d="M70 110 L 40 180 L 55 190 L 80 120 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
        ...
        <path d="M130 110 L 160 180 L 145 190 L 120 120 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
          :class="isSelected('arms') ? 'fill-cyan-500 stroke-cyan-600' : 'fill-slate-300 dark:fill-slate-700 stroke-slate-400 dark:stroke-slate-600'"
          @click="togglePart('arms')" />

        <!-- Legs -->
        <path d="M65 240 L 60 380 L 95 380 L 98 245 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
        ...
        <path d="M135 240 L 140 380 L 105 380 L 102 245 Z"
          class="body-part transition-colors duration-300 cursor-pointer hover:opacity-80"
          :class="isSelected('legs') ? 'fill-cyan-500 stroke-cyan-600' : 'fill-slate-300 dark:fill-slate-700 stroke-slate-400 dark:stroke-slate-600'"
          @click="togglePart('legs')" />
      </svg>
      ...
      <div class="mt-4 flex flex-wrap gap-2 justify-center">
        <span v-for="part in modelValue" :key="part"
