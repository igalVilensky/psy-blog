    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-slate-600 dark:text-cyan-300/70 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
          Все о MindQLab — вашей лаборатории осознанного роста. Узнайте, как мы помогаем исследовать себя и достигать
          новых высот.
        </p>
      </div>
  ...
  meta: [
    {
      name: "description",
      content:
        "Ответы на вопросы о MindQLab — вашей персональной лаборатории осознанного роста. Узнайте о наших методах, инструментах и подходе к самопознанию.",
    },
    {
      name: "keywords",
      content:
...
const faqs = ref([
  ...
  },
  {
    ...
    answer:
      "Нет, MindQLab создан для всех. Мы переводим сложные научные концепции на понятный язык и даем конкретные, применимые рекомендации на основе ваших результатов.",
    isOpen: false,
  },
  {
  ...
  },
  {
    ...
    answer:
      "Абсолютно. В MindQLab конфиденциальность — приоритет. Ваши результаты исследований и личные записи зашифрованы и доступны только вам.",
    isOpen: false,
  },
]);
