  ...
  <div class="relative min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
    <div class="container mx-auto px-4 xl:px-0 max-w-6xl relative z-10 py-10 lg:py-20">
      ...
      <div v-if="isLoading" class="flex flex-col items-center justify-center min-h-[60vh]">
        <div class="relative">
          <div class="w-16 h-16 border-4 border-purple-200 dark:border-purple-900/30 rounded-full animate-spin"></div>
          <div
      ...
      <div v-else-if="result" class="space-y-12">
        ...
        <div
          ...
          <div v-if="!auth.currentUser" class="mb-12">
            <div class="relative overflow-hidden bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-1">
              <div class="bg-white/90 dark:bg-slate-800/90 rounded-lg py-8 px-4 sm:px-8 relative backdrop-blur-sm">
                  ...
                  <div
                    ...
                    <div class="inline-block mb-4">
                      <div
                        ...
                        <i class="fas fa-unlock-alt text-2xl text-purple-600 dark:text-purple-400"></i>
                      </div>
                    </div>
                  ...
                  <div class="order-2 md:order-1 hidden sm:block">
                    ...
                    <ul class="space-y-3 text-left text-slate-700 dark:text-slate-300">
                      <li class="flex items-start gap-3">
                        ...
                        <span>Подробные гайды по вашим доминирующим архетипам</span>
                      </li>
                      <li class="flex items-start gap-3">
                        <div
                          class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
          ...
          <div class="grid gap-6 md:grid-cols-3">
            <div v-for="({ archetype, score, guideUrl }, index) in topArchetypes" :key="archetype"
              ...
              <div class="mb-4 mt-2">
                <div
                  ...
                  <i :class="`fas ${getArchetypeIcon(
                    archetype
                  )} text-purple-600 dark:text-purple-400 text-xl`"></i>
                </div>
              ...
              <button v-if="auth.currentUser" @click="handleDownload(guideUrl)"
        ...
        <div
          class="bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-200 dark:border-slate-800 py-8 px-4 sm:px-8 shadow-xl">
          <h2 class="text-2xl font-semibold text-slate-900 dark:text-white mb-8 flex items-center gap-3">
            <i class="fas fa-chart-bar text-emerald-500"></i>
            Подробный Анализ
          </h2>
          <div class="grid gap-4 md:grid-cols-2">
            <div v-for="(score, archetype) in result.scores" :key="archetype"
              ...
              <div class="flex flex-wrap justify-between items-center mb-3">
                ...
                <span class="text-purple-600 dark:text-purple-400 font-bold text-lg">{{ Math.round(score) }}/30</span>
              </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between gap-4 mt-8">
          <NuxtLink to="/space/growth/life-purpose-archetype"
          ...
          <NuxtLink to="/space/growth/life-purpose-archetype/explanation"
