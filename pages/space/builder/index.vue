...
import FlowCard from '~/components/space/FlowCard.vue'
import FlowExecutor from '~/components/space/FlowExecutor.vue'
import ScheduleConfig, { type FlowSchedule } from '~/components/space/ScheduleConfig.vue'
...
const availableModules: Module[] = [
  // Games
  {
    ...
    path: '/space/brain-training/memory'
  },
  {
    id: 'game-reaction',
    type: 'game',
    ...
    path: '/space/brain-training/reaction'
  },
  {
    id: 'game-stroop',
    type: 'game',
    ...
    path: '/space/brain-training/stroop'
  },
...
const toggleShare = async (flow: LabFlow) => {
  ...
  try {
    ...
    if (newIsPublic) {
      ...
      const shareLink = `${window.location.origin}/space/flow/${flow.id}`
  ...
  <div class="flex min-h-screen">
    ...
    <aside
      ...
      <div class="shrink-0 border-b border-slate-200 p-6 dark:border-cyan-500/20">
        ...
        <!-- Lab Logo -->
        <NuxtLink to="/space" class="lab-logo group block">
          <div
