        ...
        <div class="flex flex-col items-center gap-4 py-8 border-t border-slate-200/50 dark:border-white/5">
          <div class="flex items-center gap-3 text-slate-500 dark:text-slate-400 text-sm font-light tracking-wide">
            ...
            <NuxtLink to="/space/dashboard"
              class="text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors">Войти в
              MindQLab</NuxtLink>
...
useHead({
  ...
  meta: [
    ...
    { property: "og:url", content: "https://www.mindqlab.com/space" },
  ...
  link: [{ rel: "canonical", href: "https://www.mindqlab.com/space" }],
});
</script>
