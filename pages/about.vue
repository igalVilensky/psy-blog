<template>
  <div class="relative min-h-screen">
    <div class="container mx-auto max-w-6xl relative z-10 py-12 px-4 sm:px-0">
      ...
      <ScrollGlowSection>
        <section
          class="relative overflow-hidden bg-gradient-to-b from-[#1A1F35]/40 to-[#1E293B]/60 backdrop-blur-xl rounded-2xl border border-[#0EA5E9]/20 py-6 sm:p-12 mb-12 transition-all duration-300 hover:shadow-[0_0_20px_5px_rgba(14,165,233,0.3)]"
        >
