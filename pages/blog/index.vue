    ...
    <main class="container mx-auto max-w-6xl px-4 sm:px-0 pb-16 md:pb-24 mt-8">
      ...
      >
        <article
          ...
          :key="post._id"
          class="post-card group bg-gradient-to-br from-slate-900/60 via-slate-900/40 to-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-800/60 overflow-hidden transition-all duration-500 hover:border-cyan-500/60 hover:shadow-2xl hover:shadow-cyan-500/20 hover:scale-[1.02] cursor-pointer"
        ...
        >
          ...
          <div class="p-6">
            <h2
              class="text-lg md:text-xl font-bold text-white mb-4 line-clamp-2 group-hover:text-cyan-400 transition-colors duration-300"
            >
              {{ post.title }}
            </h2>
            ...
            <!-- Meta Info -->
            <div
              class="flex items-center justify-between text-xs text-slate-400 pt-4 border-t border-slate-800/60"
            >
              <div class="flex items-center space-x-1.5 group/views">
                <i
                  class="far fa-eye text-cyan-400 group-hover/views:scale-110 transition-transform duration-300"
                ></i>
                <span>{{ post.views || 0 }}</span>
              </div>
              <div class="flex items-center space-x-1.5 group/time">
                <i
                  class="far fa-clock text-purple-400 group-hover/time:scale-110 transition-transform duration-300"
                ></i>
                <span>{{ post.readtime }} мин</span>
              </div>
              <div class="flex items-center space-x-1.5 group/date">
                <i
                  class="far fa-calendar text-pink-400 group-hover/date:scale-110 transition-transform duration-300"
                ></i>
                <span>{{
