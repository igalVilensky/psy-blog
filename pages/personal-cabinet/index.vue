  ...
  <div class="w-full min-h-screen bg-gray-50/30">
    <div class="max-w-6xl mx-auto py-8 sm:py-12">
        ...
        <div
          ...
          <div class="mt-4">
            <div class="w-full bg-gray-100 rounded-full h-2.5">
              <div class="bg-blue-500 h-2.5 rounded-full" :style="{ width: `${lastWeekProgress.progressPercentage}%` }">
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="!loading" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <NuxtLink to="/personal-cabinet/courses"
          ...
          <div class="flex items-center">
            ...
            <div class="text-blue-500 group-hover:translate-x-2 transition-transform duration-200">
              <i class="fas fa-arrow-right text-xl"></i>
            </div>
          </div>
        </NuxtLink>

        <NuxtLink to="/personal-cabinet/progress"
          class="group bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg transition-all duration-300">
          <div class="flex items-center">
            <div class="bg-green-50 p-4 rounded-xl group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="ml-6 flex-1">
              <h2 class="text-xl font-bold text-gray-900 group-hover:text-green-600 transition-colors duration-200">
                Ваш прогресс
              </h2>
              <p class="mt-2 text-gray-600">
            ...
            <div class="text-green-500 group-hover:translate-x-2 transition-transform duration-200">
              <i class="fas fa-arrow-right text-xl"></i>
            </div>
          </div>
        </NuxtLink>
