          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500 mt-1">
                {{ completedLessons }} из {{ course.lessons }} уроков
              </p>
            </div>
            <div
...
const remainingTime = computed(() => {
  const remainingLessons = lessons.length - completedLessons.value;
...
// Next lesson is always the first lesson
const nextLesson = ref({
  ...lessons[0], // Use the first lesson
  number: 1, // Explicitly set the lesson number
});
